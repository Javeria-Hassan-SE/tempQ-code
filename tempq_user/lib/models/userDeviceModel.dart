...
class UserDeviceModel {
  ...
  final int userDeviceID, userId, isEnabled;
  ...
  // factory UserDeviceModel.withA() => UserDeviceModel._internal();
  // UserDeviceModel._internal();
  ...
  factory UserDeviceModel.fromJson(Map<String, dynamic> json) {
    return UserDeviceModel(
        ...
        status: json['status'],
        isEnabled: int.parse(json['enable_request']),
