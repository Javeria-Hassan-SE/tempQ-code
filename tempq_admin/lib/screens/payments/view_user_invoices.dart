...
import 'package:tempq_admin/screens/payments/view_pdf.dart';
...
class PdfData {
  ...
  PdfData({required this.userId, required this.invoiceId, required this.fileUrl,
    required this.timeStamp, required this.deviceID, required this.userName});
...
class _PdfListScreenState extends State<PdfListScreen> {
  ...
  Future<void> fetchPdfData() async {
    const url = 'http://tempq.frostcarusa.com/tempQ/admin/retreive_all_pdf.php'; // Replace with your API endpoint
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:defaultAppBar(context, "User Invoices"),
            ...
            Padding(
              ...
              child: Card(
                child: ListTile(
                  ...
                  subtitle: Text(
                      'Device ID: ${pdfData.deviceID}\n'
                      'User: ${pdfData.userName}\n'
                          'Invoice Generated: ${FormatDate.formatDateTime(pdfData.timeStamp.toString())}',
